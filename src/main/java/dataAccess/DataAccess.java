...
public class DataAccess  {
	 ...
	 */
	public User createUser(String name, String surnames, String dni, Date birthdate, String passwd, boolean isAdmin) throws ObjectAlreadyExistException {
        System.out.println(">> DataAccess: CreateUser=> name = "+name+" dni = "+dni);

        if(db.find(User.class, dni) != null) throw new ObjectAlreadyExistException("The user already exists");
	...
	public Event createEvent(String description, Date eventDate) throws ObjectAlreadyExistException {
        ...
        if(!query.getResultList().isEmpty()) throw new ObjectAlreadyExistException("the event already exists");
    ...
    /**
     * creates a bet, if the user already has a bet for that forecast, the bet is updated
    ...
    public User getUser(String dni) throws UserNotFound {
        ...
        if(usr == null) throw new UserNotFound("User not found.");
    ...
    public Card addCard(User usr, String cardNum, int cvv, String last3Digits) throws ObjectAlreadyExistException {
        ...
        if(card != null) throw new ObjectAlreadyExistException("the card already exists");
    ...
    public User guardarCambios(String name, String surnames, Date birthdate, String dni, String passwd, byte[] img) {
    	System.out.println(">> DataAccess: guardarCambios => name="+ name+"surname"+surnames+"birthdate"+birthdate+"dni"+dni);
