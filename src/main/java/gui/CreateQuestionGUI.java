...
public class CreateQuestionGUI extends JFrame {
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jTextFieldQuery.setBorder(BorderFactory.createEmptyBorder());
		jLabelMinBet.setBounds(new Rectangle(25, 243, 75, 20));
		jTextFieldPrice.setBounds(new Rectangle(100, 243, 60, 20));
		jTextFieldPrice.setBorder(BorderFactory.createEmptyBorder());
		jCalendar.setBounds(new Rectangle(40, 50, 225, 150));
		scrollPaneEvents.setBounds(new Rectangle(25, 44, 346, 116));

		jButtonCreate.setBounds(new Rectangle(100, 275, 130, 30));
		jButtonCreate.setEnabled(false);
		jButtonCreate.setBorder(BorderFactory.createEmptyBorder());
		jButtonCreate.setBackground(new Color(180, 180, 180));
		jButtonCreate.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				jButtonCreate.setBackground(new Color(70, 130, 180));
